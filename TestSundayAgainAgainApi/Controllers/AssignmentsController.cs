...
namespace TestSundayAgainAgainApi.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class AssignmentsController : ControllerBase
    {
        private readonly TestSundayAgainAgainApiContext _context;

        public AssignmentsController(TestSundayAgainAgainApiContext context)
        {
            _context = context;
        }
